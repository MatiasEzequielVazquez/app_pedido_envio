...
public class AppMenu {
    ...
    public AppMenu() {
        ...
        EnvioServiceImpl personaService = createPersonaService();
     ...
     */
    private EnvioServiceImpl createPersonaService() {
        PedidoDAO domicilioDAO = new PedidoDAO();
        EnvioDAO personaDAO = new EnvioDAO(domicilioDAO);
        PedidoServiceImpl domicilioService = new PedidoServiceImpl(domicilioDAO);
        return new EnvioServiceImpl(personaDAO, domicilioService);
    }
}