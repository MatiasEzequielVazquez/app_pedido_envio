...
public class EnvioDAO implements GenericDAO<Envio> {
     ...
     */
    private final PedidoDAO domicilioDAO;
     ...
     */
    public EnvioDAO(PedidoDAO domicilioDAO) {
     ...
     *
     * @param persona Envio a insertar (id será ignorado y regenerado)
     * @throws Exception Si falla la inserción o no se obtiene ID generado
     */
    @Override
    public void insertar(Envio persona) throws Exception {
     ...
     *
     * @param persona Envio con los datos actualizados (id debe ser > 0)
     * @throws SQLException Si la persona no existe o hay error de BD
     */
    @Override
    public void actualizar(Envio persona) throws Exception {
        try (Connection conn = DatabaseConnection.getConnection();
     ...
     * @return Envio encontrada con su domicilio, o null si no existe o está eliminada
    ...
    public List<Envio> getAll() throws Exception {
        List<Envio> personas = new ArrayList<>();
     ...
     */
    public List<Envio> buscarPorNombreApellido(String filtro) throws SQLException {
     ...
     * @return Envio con ese DNI, o null si no existe o está eliminada
     * @throws IllegalArgumentException Si el DNI está vacío
     * @throws SQLException Si hay error de BD
     */
    public Envio buscarPorDni(String dni) throws SQLException {
     ...
     * @param persona Envio con los datos a insertar
     * @throws SQLException Si hay error al setear parámetros
     */
    private void setPersonaParameters(PreparedStatement stmt, Envio persona) throws SQLException {
        stmt.setString(1, persona.getNombre());
        stmt.setString(2, persona.getApellido());
        stmt.setString(3, persona.getDni());
        setDomicilioId(stmt, 4, persona.getDomicilio());
     ...
     * @param domicilio Pedido asociado (puede ser null)
     * @throws SQLException Si hay error al setear el parámetro
     */
    private void setDomicilioId(PreparedStatement stmt, int parameterIndex, Pedido domicilio) throws SQLException {
     ...
     */
    private void setGeneratedId(PreparedStatement stmt, Envio persona) throws SQLException {
     ...
     * @return Envio reconstruida con su domicilio (si tiene)
     * @throws SQLException Si hay error al leer columnas del ResultSet
     */
    private Envio mapResultSetToPersona(ResultSet rs) throws SQLException {
        Envio persona = new Envio();
