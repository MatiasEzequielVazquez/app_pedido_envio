...
public class EnvioServiceImpl implements GenericService<Envio> {
     ...
     */
    private final EnvioDAO personaDAO;
     ...
     */
    private final PedidoServiceImpl domicilioServiceImpl;
     ...
     */
    public EnvioServiceImpl(EnvioDAO personaDAO, PedidoServiceImpl domicilioServiceImpl) {
        if (personaDAO == null) {
    ...
    public void insertar(Envio persona) throws Exception {
        ...
        if (persona.getDomicilio() != null) {
            if (persona.getDomicilio().getId() == 0) {
                // Pedido nuevo: insertar primero para obtener ID autogenerado
                domicilioServiceImpl.insertar(persona.getDomicilio());
            } else {
                // Pedido existente: actualizar datos
     ...
     *
     * @param persona Envio con los datos actualizados
     ...
     * @return Envio encontrada (con su domicilio si tiene), o null si no existe o está eliminada
     ...
     */
    public PedidoServiceImpl getDomicilioService() {
     ...
     * @throws Exception Si hay error de BD
     */
    public List<Envio> buscarPorNombreApellido(String filtro) throws Exception {
     ...
     * @throws Exception Si hay error de BD
     */
    public Envio buscarPorDni(String dni) throws Exception {
    ...
    public void eliminarDomicilioDePersona(int personaId, int domicilioId) throws Exception {
        ...
        Envio persona = personaDAO.getById(personaId);
        if (persona == null) {
     ...
     *
     * @param persona Envio a validar
     * @throws IllegalArgumentException Si alguna validación falla
     */
    private void validatePersona(Envio persona) {
        if (persona == null) {
    ...
    private void validateDniUnique(String dni, Integer personaId) throws Exception {
        Envio existente = personaDAO.buscarPorDni(dni);
        if (existente != null) {
